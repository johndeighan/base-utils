...
(() =>
	...
	table.callback () => return 'more literal text'
...
(() =>
	...
	u.equal table.lRows, [
		...
		{
			opcode: 'data'
			lFormatted: ['', '10.00', '20.00']
			}
		{
			opcode: 'data'
			lFormatted: ['', '1000.00', '40.00']
			}
		]
