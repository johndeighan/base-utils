...
// ---------------------------------------------------------------------------
export var debugV8Stack = function(flag = true) {
  internalDebugging = flag;
};

// ---------------------------------------------------------------------------
export var getV8StackStr = function(maxDepth = 2e308) {
...
// ---------------------------------------------------------------------------
export var getV8Stack = function(maxDepth = 2e308) {
  var stackStr;
...
// ---------------------------------------------------------------------------
export var getMyself = function(depth = 3) {
...
// ---------------------------------------------------------------------------
export var getMyDirectCaller = function(depth = 3) {
  var hNode, ref, stackStr;
...
// ---------------------------------------------------------------------------
export var getMyOutsideCaller = function() {
...
// ---------------------------------------------------------------------------
mksource = function(dir, base) {
  return `${dir}/${base}`;
};

// ---------------------------------------------------------------------------
export var parseLine = function(line, depth) {
...
// ---------------------------------------------------------------------------
export var parseFileURL = function(url) {
...
// ---------------------------------------------------------------------------
export var shorten = function(line) {
  var pos, root;
  if (isEmpty(line)) {
    return '';
  }
